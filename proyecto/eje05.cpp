...
int main(){ //record
  ...
  if (periodo == 1){
   ...
   promedio = ((nota1+nota2+nota3)/3 * 6/10) + (nota4*4/10);
     ...
     cout <<"la fecha: "; 
     getline(cin,fecha1);cout <<"saco: "<<nota1;
     cout <<"la fecha: "; 
     getline(cin,fecha2);cout <<"saco: "<<nota2;
     cout <<"la fecha: "; 
     getline(cin,fecha3);cout <<"saco: "<<nota3;
     if(periodo ==2||periodo == 3){
     cout <<"la fecha: "; 
     getline(cin,fecha4);cout <<"saco: "<<nota4;
     }
